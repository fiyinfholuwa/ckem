...
{{--            <h1>Servo<span class="corp">Corp</span></h1>--}}
            <h3><a style="padding: 10px; background-color: red; color: #fff !important; border-radius: 5px;" href="{{route('login')}}">Login</a></h3>
            <hr class="rounded">
            <h3>Coming Soon - <span class="corp">CKEMINTL.ORG</span></h3>
